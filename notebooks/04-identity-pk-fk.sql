...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=DBSQL&org_id=8271961813636051&notebook=%2F00-Identity_PK_FK&demo_name=identity-pk-fk&event=VIEW&path=%2F_dbdemos%2FDBSQL%2Fidentity-pk-fk%2F00-Identity_PK_FK&version=1">

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC ### A cluster has been created for this demo
-- MAGIC To run this demo, just select the cluster `dbdemos-identity-pk-fk-alvaro_perez` from the dropdown menu ([open cluster configuration](https://adb-8271961813636051.11.azuredatabricks.net/#setting/clusters/0513-181458-nj57v1ey/configuration)). <br />
-- MAGIC *Note: If the cluster was deleted after 30 days, you can re-create it with `dbdemos.create_cluster('identity-pk-fk')` or re-install the demo: `dbdemos.install('identity-pk-fk')`*
