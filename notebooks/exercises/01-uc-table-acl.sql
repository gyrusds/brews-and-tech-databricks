...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&org_id=8271961813636051&notebook=%2F00-UC-Table-ACL&demo_name=uc-01-acl&event=VIEW&path=%2F_dbdemos%2Fgovernance%2Fuc-01-acl%2F00-UC-Table-ACL&version=1">

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC ### A cluster has been created for this demo
-- MAGIC To run this demo, just select the cluster `dbdemos-uc-01-acl-alvaro_perez` from the dropdown menu ([open cluster configuration](https://adb-8271961813636051.11.azuredatabricks.net/#setting/clusters/0513-175846-7luiovyk/configuration)). <br />
...
-- MAGIC %python
-- MAGIC # Use schema and catalog for the demo
...
-- Grant to all users access and modification rights to table customers
