...
-- MAGIC
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&org_id=8271961813636051&notebook=%2F02-provider-delta-sharing-demo&demo_name=delta-sharing-airlines&event=VIEW&path=%2F_dbdemos%2Fgovernance%2Fdelta-sharing-airlines%2F02-provider-delta-sharing-demo&version=1">

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC ### A cluster has been created for this demo
-- MAGIC To run this demo, just select the cluster `dbdemos-delta-sharing-airlines-alvaro_perez` from the dropdown menu ([open cluster configuration](https://adb-8271961813636051.11.azuredatabricks.net/#setting/clusters/0520-094245-80ei273f/configuration)). <br />
